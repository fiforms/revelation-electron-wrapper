...
async function importPresentation(AppContext) {
  ...
  try {
    ...
    const destPath = path.join(AppContext.presentationsDir, slug);
    ...
    const indexPath = path.join(AppContext.presentationsDir, 'index.json');

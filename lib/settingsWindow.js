...
const settingsWindow = {
  ...
  reset(AppContext) {
    ...
    const response = dialog.showMessageBoxSync(AppContext.win, {
      ...
      message: AppContext.translate('Are you sure you want to reset all settings to default?'),
    ...
    if (fs.existsSync(configPath)) {
      ...
      message = AppContext.translate('Settings reset to default.');
    } else {
      message = AppContext.translate('No settings file found to reset.');
    }

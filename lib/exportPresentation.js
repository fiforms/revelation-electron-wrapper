...
const exportPresentation = {
  ...
  register(ipcMain, AppContext) {
    ...
    ipcMain.handle('export-presentation', async (event, slug, includeMedia) => {
      ...
      return await this.run(folderPath, slug, includeMedia, event);
    });
  },

  // Open the export presentation window
  async run(folderPath, slug, includeMedia, event) {

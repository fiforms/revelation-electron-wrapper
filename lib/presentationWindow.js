...
const presentationWindow = {
    ...
    async openWindow(AppContext, slug, mdFile = 'presentation.md', fullscreen) {
      ...
      if (false && process.env.XDG_SESSION_TYPE === 'wayland' && !AppContext.config.forceX11OnWayland) {
        // forceX11OnWayland is not yet implemented, always use the same window method

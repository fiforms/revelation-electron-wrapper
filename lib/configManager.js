...
const defaultConfig = {
  ...
  // to mint signatures a WordPress site will honour. See SECURITY.md (F2).
  ...
  if (Array.isArray(out.pairedMasters)) {
    out.pairedMasters = out.pairedMasters
      ...
      .map((item) => ({
        ...
        // which is no longer what peer signatures are made with (SECURITY.md

...
const { getDefaultEnabledPluginIds } = require('./pluginBootstrap');
...
const coreDefaultPlugins = ["addmedia","bibletext","hymnary","virtualbiblesnapshots", "resources", "mediafx", "compactor", "richbuilder", "slidesorter"];
const defaultPlugins = [...new Set([...coreDefaultPlugins, ...getDefaultEnabledPluginIds(defaultPluginDir)])];
